        ...
        <form action="/register" class="form" method="post" novalidate>
            ...
            <ul class="form__group-ul">
                <li class="form__group-item">
                    ...
                    <input type="text" id="purchase_post_code" name="purchase_post_code" value="{{ old('purchase_post_code') }}"/>
                </li>
                ...
                <li class="form__group-item">
                    ...
                    <input type="text" id="purchase_address" name="purchase_address" value="{{ old('purchase_address') }}"/>
                </li>
                <div class="form__error">
                ...
                <li class="form__group-item">
                    ...
                    <input type="text" id="purchase_building" name="purchase_building" value="{{ old('purchase_building') }}"/>
                </li>
